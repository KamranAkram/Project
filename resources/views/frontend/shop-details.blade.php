                    ...
                    <div class="col-lg-3 col-md-3">
                        <ul class="nav nav-tabs" role="tablist">
                            @foreach ($images as $item)
                                <li class="nav-item">
                                    <a class="nav-link" onclick="updateFeaturedImage('{{ asset($item->image) }}')">
                                        <div class="product__thumb__pic set-bg" data-setbg="{{ asset($item->image) }}">
                                        </div>
                                    </a>
                                </li>
                            @endforeach
                        ...
                        <div class="tab-content">
                            <div>
                                <div class="product__details__pic__item">
                                    <img id="featuredImage" src="{{ asset($images[0]->image) }}" alt="Featured image">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-8">
                        <div class="product__details__text">
                            ...
                            <h3>${{ $product->price }} <span>${{ $product->compare_price }}</span></h3>
                ...
                @foreach ($products as $product)
                    <div class="col-lg-3 col-md-6 col-sm-6 col-sm-6">
                        <div class="product__item">
                            @if ($product->product_image->isNotEmpty())
                                <div class="product__item__pic set-bg"
                                    data-setbg="{{ asset($product->product_image[0]->image) }}">
                            @endif
                            ...
                            <ul class="product__hover">
                                ...
                                <li><a href="{{ route('detail', [$product->id, $product->slug]) }}"><img
                        ...
                        <div class="product__item__text">
                            ...
                            <span class="d-flex">
                                <p class="px-1 text-dark">${{ $product->price }}</p>
                                <p class="px-1 text-dark"><del>${{ $product->compare_price }}</del></p>
                            </span>
