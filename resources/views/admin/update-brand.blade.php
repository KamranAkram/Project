        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h1 class="text-center text-primary pt-2" style="font-weight: bold">Update Brand</h1>
                        ...
                        <div class="container mt-4 card bg-white p-3">
                            <div class="row">
                                ...
                                <div class="col-md-6 mt-2">
                                    ...
                                    <input type="text" readonly class="form-control" id="slug" name="slug" value="{{ $brand->slug }}">
                                    <span class="text-danger">
                                        @error('slug')
                                            {{ $message }}
                                        @enderror
