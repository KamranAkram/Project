        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h1 class="text-center text-primary pt-2" style="font-weight: bold">Update Product</h1>
                    <a class="btn btn-primary" href="{{ route('admin.show-product') }}">Products</a>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.update-product' , $product->id) }}" method="POST" id="productForm" enctype="multipart/form-data">
                        @csrf
                        <div class="container mt-4 card bg-white p-3">
                            <div class="row">
                                ...
                                <div class="col-md-6 mt-2">
                                    ...
                                    <input type="text" readonly class="form-control" id="slug" name="slug" value="{{$product->slug}}">
                                    <p class="error"></p>
                                </div>
                                <div class="col-md-12 mt-2">
                                    <label for="desc">Description</label>
                                    <textarea name="description" id="desc" cols="100" rows="10" value="{{$product->description}}"></textarea>
                                </div>
                                <div class="col-md-6 mt-2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-5 mt-2">
                                                ...
                                                <select id="value" class="form-select" name="value_id[]" multiple
                                                    ...
                                                    <option value="" disabled>Select the Attribute Values</option>
                                                </select>
                                                <p class="error"></p>
                                            </div>
