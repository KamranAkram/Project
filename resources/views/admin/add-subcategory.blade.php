        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h1 class="text-center text-primary pt-2" style="font-weight: bold">Add a New Sub-Category</h1>
                    <a class="btn btn-primary" href="{{ route('admin.show-subcat') }}" >Back</a>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.add-sub-cat') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="container mt-4 card bg-white p-3">
                            <div class="row">
                                ...
                                <div class="col-md-6 mt-2">
                                    ...
                                    <input type="text" class="form-control" id="sub" name="name" value="">
                                    <span class="text-danger">
                                        @error('name')
                                            {{ $message }}
                                        @enderror
